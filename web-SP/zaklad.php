    ...
    <body>
        ...
        <nav class="navbar navbar-inverse">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php?page=5">Domů</a>
            </div>
            <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="registrace"><span class="glyphicon glyphicon-user"></span> Registrace</a></li>
                    <li><a href="prihlaseni"><span class="glyphicon glyphicon-log-in"></span> Přihlásit</a></li>
                </ul>
            </div>
        </nav>
...
function createSelectBox($rights,$selected){
    ...
    foreach($rights as $r){
        if($selected!=null && $selected==$r['idprava']){
...
function createSelectBoxL($rights,$selected){
    ...
    foreach($rights as $r){
        if($selected!=null && $selected==$r['idlicence']){
